...
namespace UglyFramework
{
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        protected ParticleSystem(GameBase game, int howManyEffects)
            : base(game)
        {            
            this.game = game;
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            // initializeConstants
            game.SpriteBatch.Begin(SpriteBlendMode.AlphaBlend, SpriteSortMode.BackToFront, SaveStateMode.SaveState);
